...
var spanQueue = document.querySelector('#queue'); // 取到 当前队列
...
btnCreateNumber.onclick = function () {
  n += 1;
  queue.push.call(null, n); // 将取得的好记录下来 // queue.push(n)

  spanNewNumber.innerHTML = n; // spanQueue.innerText = queue.toString() // spanQueue.innerText = queue.toString()  只能显示字符串，会用逗号连接 不美观 1,2,3,4,5 变为字符串格式的[]
